            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (auth()->user()->role_id == 2)
                        ...
                        <x-jet-nav-link href="{{ route('student.grading.index') }}" :active="request()->routeIs('student.grading.index')">
                            {{ __('Grades') }}
                        </x-jet-nav-link>
                    @endif
                    ...
                    @if (auth()->user()->role_id == 3)
                        ...
                        <x-jet-nav-link href="{{ route('teacher.grading.index') }}" :active="request()->routeIs('teacher.grading.index')">
                            {{ __('Grading Sheet') }}
                        </x-jet-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('admin.users.index') }}" :active="request()->routeIs('admin.users.index')">
                    ...
                    @if (auth()->user()->role_id == 2)
                        <x-jet-responsive-nav-link href="{{ route('student.lessons.index') }}" :active="request()->routeIs('student.lessons.index')">
                            {{ __('Lessons') }}
                        </x-jet-responsive-nav-link>

                        <x-jet-responsive-nav-link href="{{ route('student.grading.index') }}" :active="request()->routeIs('student.grading.index')">
                            {{ __('Grades') }}
                        </x-jet-responsive-nav-link>
                    @endif
                    ...
                    @if (auth()->user()->role_id == 3)
                        ...
                        <x-jet-responsive-nav-link href="{{ route('teacher.grading.index') }}" :active="request()->routeIs('teacher.grading.index')">
                            {{ __('Grading Sheet') }}
                        </x-jet-responsive-nav-link>
                    @endif
        </div>
